            ...
            <input
                ...
                className={
                    props.errorMessage
                        ...
                        : ` ${'h-12 pl-5 bg-white rounded-lg border border-gray-200 focus:ring-gradientSecond focus:border-0 w-full'} ${!props.class && 'md:w-96'
                        }`
                }
            />
            {props.errorMessage && <p className="text-red-500 text-[13px] mt-2">{props.errorMessage}</p>}
...
export const SubmitButton = (props: any) => {
    return (
        <button disabled={props.loading ? true : false} type="submit" className="bg-black w-full rounded-lg text-textW h-14">
