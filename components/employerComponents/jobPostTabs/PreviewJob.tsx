...
const PreviewJob = (props: any) => {
    ...
    return (
        ...
        >
            <div ref={parentRef} onClick={handleParentClick} className='w-screen h-screen p-2 flex items-center justify-center sm:p-10 md:p-10 lg:px-20 xl:px-40 xl:py-10'>
                <div onClick={handleChildClick} className='bg-textW w-full h-full rounded-2xl p-3 sm:p-10'>
                    <div className='flex max-sm:flex-col max-md:flex-wrap h-full gap-3 lg:gap-6'>
                        <div className='w-full flex justify-between h-16 md:hidden'>
                            <div className='flex gap-2'>
                                <div className=' flex flex-wrap justify-center md:w-full max-md:order-1'>
                                    <img src='/images/NotFound.svg' className='w-10 h-10' />
                                </div>
                                <div className=' flex-grow max-md:order-2 flex flex-col'>
                                    <p className='font-[600] text-md'>This is a preview of what people may see</p>
                                    <p className='text-gray-500 text-sm'>Your job post may look slightly different when it is live</p>
                                </div>
                            </div>
                        ...
                        <div className="w-full flex flex-col gap-y-5 pt-5 rounded-t-xl max-sm:flex-grow md:w-1/2 lg:w-2/3">
                        ...
                        <div className='max-md:hidden bg-gray-100 flex-grow flex h-full  px-5 pt-5 max-md:pb-2 gap-7 md:flex-col md:flex md:w-1/5 order-1 md:order-2'>
                            <div className=' flex justify-end max-md:order-3 md:w-full'>
                                <div className='cursor-pointer hover:text-gradientFirst' onClick={() => props.setOpenModal(false)}>
                                    <CloseIcon />
                                </div>
