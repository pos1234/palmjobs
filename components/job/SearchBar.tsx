...
const SearchBar = (props: any) => {
    return (
        <div className={`w-full max-sm:px-3 flex flex-col gap-2 ${props.home == true ? 'sm:items-start' : 'sm:items-center'}`}>
                ...
                <div className="w-full h-full max-h-[5rem] flex gap-1 items-center h-[40px]">
                    <div className='relative flex items-center max-sm:w-full h-[40px] sm:w-5/6'>
                        ...
                        <input
                            ...
                            className="h-full w-full bg-gray-100 max-sm:rounded-full rounded-l-full pl-10 px-3 py-3 border-[1px] border-gray-100 focus:border-gradientFirst outline-none focus:ring-0 focus:outline-none"
                            placeholder="What"
                        />
                    </div>
